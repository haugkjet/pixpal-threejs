...
const cube0 = new THREE.Mesh(geometry0, materialAtlas);
...
const cube = new THREE.Mesh(geometry, materialAtlas);
...
const cube2 = new THREE.Mesh(geometry2, materialAtlas);
...
const cube3 = new THREE.Mesh(geometry3, materialAtlas);
...
const cube5 = new THREE.Mesh(geometry5, materialAtlas);
...
const cube6 = new THREE.Mesh(geometry6, materialAtlas);
...
const cube7 = new THREE.Mesh(geometry7, materialAtlas);
...
const cube8 = new THREE.Mesh(geometry8, materialAtlas);
...
const cube9 = new THREE.Mesh(geometry9, materialAtlas);
